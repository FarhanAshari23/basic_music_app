class AppVectors {
  ...
  static const String topPattern = "${basePath}top$format";
  static const String bottomPattern = "${basePath}bottom$format";
  static const String homeTopCard = "${basePath}home_page_card$format";
}
