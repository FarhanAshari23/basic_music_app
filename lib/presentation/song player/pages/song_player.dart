...
import 'package:spotify/presentation/song%20player/bloc/song_player_cubit.dart';
import 'package:spotify/presentation/song%20player/bloc/song_player_state.dart';
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (_) => SongPlayerCubit()
          ..loadSong(
              '${AppURLs.musicFirestorage}${songEntity.artist} -${songEntity.title}.mp3?${AppURLs.mediaAlt}'),
